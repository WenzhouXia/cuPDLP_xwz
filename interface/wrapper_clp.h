...
#define CUPDLP_INIT(var, size)                                  \
  ...
  void checkConstraint_Keep_redundancy_Wrapper(long long **keep_checkConstraint, long long *keep_checkConstraint_len, double *x_init, int resolution_now, int resolution_last, double thr, double violate_degree);
  ...
  void countZero_Keep_redundancy_Ykeep_withoutRecover_Wrapper(long long **keep_countZero, long long *keep_countZero_len, double *y_solution_last, long long y_solution_last_len, long long *y_solution_last_keep, int resolution_now, int resolution_last, double thr);
